...
const std::vector<uint16_t> indices = {
	//1, 0, 3, 3, 2, 1 square
	//2, 1, 3, 3, 0, 1, 1, 0, 3, 3, 2, 1 square
	//1, 0, 3, 2, 1, 3 square
	//2, 1, 3, 1, 0, 3 square

	//1, 0, 3, 1, 2, 3 left triangle


	//2, 1, 3, 3, 0, 1 right triangle
	//2, 1, 3, 3, 2, 2 right triangle
	//2, 1, 3, 3, 0, 1, 1, 3, 0, 2, 3, 1 right triangle
	//2, 1, 3, 3, 0, 1, 2, 1, 3, 3, 0, 1 right triangle
	//
	//1, 3, 0, 2, 1, 3 right triangle
	//
	//2, 3, 0, 0, 1, 2	right triangle
	0, 1, 2, 2, 3, 0
};
...
private:
	...
	void createGraphicsPipeline() {
		...
		VkResult pipelineLayoutCreatingResult = vkCreatePipelineLayout(device, &pipelineLayoutInfo, nullptr, &pipelineLayout);
		...
		VkResult pipelineCreatingResult = vkCreateGraphicsPipelines(device, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &graphicsPipeline);
	...
	VkCommandBuffer beginSingleTimeCommands() {
		...
		VkCommandBufferBeginInfo beginInfo{};
		beginInfo.sType = VK_STRUCTURE_TYPE_COMMAND_POOL_CREATE_INFO;
		beginInfo.flags = VK_COMMAND_BUFFER_USAGE_ONE_TIME_SUBMIT_BIT;
